...
<script type="text/javascript" src="jquery.mousewheel.min.js"></script>
          ...
          <body>
<div id="outer_container" style="left: -710px;">
<div id="customScrollBox" style="height: 991px;">
	<div class="container" style="top: 0px;">
    	<div class="content">
            ...
            <div id="toolbar" style="opacity: 0.8;"><span class="lightgrey">IMAGE VIEW MODE ›</span> FULL</div><div class="clear"></div>
    ...
    <div id="dragger_container" style="height: 971px;"><div id="dragger" class="ui-draggable" style="display: block; top: 0px;"></div></div>
</div>
</div>
<div id="bg" style="left: 0px;">
    <img src="imgs/space/Universe_and_planets_digital_art_wallpaper_lucernarium.jpg" title="Supremus Lucernarium" id="bgimg" style="margin-left: -302.5px; margin-top: 0px; display: inline; width: 1585.36px; height: 991px;">
	<div id="preloader" style="display: none;"><img src="ajax-loader_dark.gif" width="32" height="32" align="absmiddle">LOADING...</div>
    <div id="arrow_indicator" style="opacity: 1; display: block;"><img src="sw_arrow_indicator.png" width="50" height="50"></div>
